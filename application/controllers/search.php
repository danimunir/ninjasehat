			...
			<div class="container">
				<div class="row">
					...
					<div class="post col-xl-6">
						<div class="post-thumbnail"><a href="<?php echo base_url()?>home/read/<?php echo $row['id']."/".strtolower($row['slug'])?>"><img src="<?php echo base_url().$row['featured_image'];?>" alt="..." class="img-fluid"  ></a></div>
						...
						<div class="post-footer d-flex align-items-center"><a href="<?php echo base_url().'home/tentang' ?>" class="author d-flex align-items-center flex-wrap">
							<div class="avatar"><img src="<?php echo base_url().'assets/img/bahyu.jpeg'?>" alt="..." class="img-fluid"></div>
